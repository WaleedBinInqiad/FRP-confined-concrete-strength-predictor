This repository features the python code for GUI developed to predict compressive strength of FRP-confined concrete. Here are some tips how we have developed the GUI.
